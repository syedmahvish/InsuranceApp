...
class ContactAgentTableViewCell: UITableViewCell {
    ...
    var delegate : ContactAgentTableViewCellConfigurable?
...
extension ContactAgentTableViewCellConfigurable {
    var profileInformationModel : ProfileInformationModel? { return nil }
    var autoInformationViewModel: AutoRenewalInfoConfigurable? { return nil }
}
